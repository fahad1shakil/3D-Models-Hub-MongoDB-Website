      ...
      <div className="navbar-end gap-3">
        {user ? (
          <div className="dropdown dropdown-end z-50">
            ...
            >
              <div className=" pb-3 border-b border-b-gray-200 px-2">
              ...
              {/* থিম টগল বাটনটি নির্দিষ্ট মাপ দিয়ে ঠিক করা হয়েছে */}
              <li className="hover:bg-transparent">
                <div className="flex justify-between items-center w-full pointer-events-auto">
                  ...
                  <input
                    ...
                    className="toggle"
                    style={{ width: "48px", height: "24px", minWidth: "48px", minHeight: "24px", flexShrink: 0 }}
                  />
                </div>
              </li>
              ...
              <li>
                <button
                  onClick={signOutUser}
                  className="btn btn-xs text-left bg-linear-to-r from-pink-500 to-red-500 text-white mt-2"
                >
                  <IoLogOut /> Logout
                </button>
              </li>
